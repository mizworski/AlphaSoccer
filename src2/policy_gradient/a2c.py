...
class Model(object):
    def __init__(self, policy, ob_space, ac_space, nsteps,
        ...
        step_model = policy(sess, ob_space, ac_space, 1, reuse=False)
        train_model = policy(sess, ob_space, ac_space, nsteps, reuse=True)
...
def learn(policy, env, seed, nsteps=5, nstack=4, total_timesteps=int(80e6), vf_coef=0.5, ent_coef=0.01,
    ...
    model = Model(policy=policy, ob_space=ob_space, ac_space=ac_space, nsteps=nsteps, ent_coef=ent_coef,
