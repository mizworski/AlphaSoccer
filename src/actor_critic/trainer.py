...
def learn(batch_size=2048, n_self_play_games=int(4e3), n_replays=int(3e5), n_total_timesteps=int(1e3),
          initial_temperature=1, initial_lr=1e-10, evaluation_temperature=0.5, n_training_steps=16,
    ...
    log_every_n_train_steps = n_training_steps // 16
    log_every_n_train_steps = max(2, log_every_n_train_steps)
